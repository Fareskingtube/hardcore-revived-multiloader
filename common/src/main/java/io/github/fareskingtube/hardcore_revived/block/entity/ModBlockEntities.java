...
public class ModBlockEntities {
    ...
    public static final BlockEntityType<DeadManSwitchBlockEntity> DEAD_MAN_SWITCH_BE = registerBlockEntity(
            "dead_man_switch_be",
            BlockEntityType.Builder.of(DeadManSwitchBlockEntity::new, ModBlocks.DEAD_MAN_SWITCH).build(null)
    );
